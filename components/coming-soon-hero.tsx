  ...
  return (
    <section className="w-full min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-5 pointer-events-none">
        <div className="w-96 h-96 rounded-full bg-accent blur-3xl transition-smooth-slow"></div>
      </div>

      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        {/* Subtle badge */}
        <div className="inline-block mb-8 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          <span className="text-xs tracking-widest uppercase text-accent">Luxury Fashion</span>
        </div>

        {/* Main headline */}
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-light tracking-tight mb-8 text-foreground text-balance animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          Exceptional
          <br />
        ...
        {/* Description */}
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 font-light leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
